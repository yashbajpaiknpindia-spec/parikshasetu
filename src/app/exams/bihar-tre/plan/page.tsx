...
export const metadata: Metadata = {
  title: "BPSC TRE 4.0 Study Plan: Classes 1–5 & 6–8",
  description:
...
export default async function BiharPlanPage() {
  const hi = (await getLang()) === "hi";
  return (
    <>
      <section className="hero-gradient">
        <Container className="py-14">
          <Link href="/exams/bihar-tre" className="text-sm text-ink-500 hover:text-brand-700">← {hi ? "BPSC TRE 4.0 परीक्षा गाइड" : "BPSC TRE 4.0 exam guide"}</Link>
      ...
      <StudyPlan tracks={TRACKS} defaultTrack="bihar-1-5" />
    </>
  );
}
